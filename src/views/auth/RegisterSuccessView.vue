...
// ✅ [FIX] Hapus temp_email dari localStorage saat component di-unmount
onUnmounted(() => {
...
const resendEmail = async () => {
  ...
  try {
    ...
    // ✅ [FIX] Handle tiap status secara spesifik
...
<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden px-6">
    <!-- Background konsisten dengan halaman auth lainnya -->
